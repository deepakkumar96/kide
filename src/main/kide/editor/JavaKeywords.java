...
public class JavaKeywords extends Application {
    ...
    public static void main(String[] args) {
        ...
        Arrays.stream(highlighter.getKeyWords()).forEach(System.out::println);
        System.out.println("Stylesheet : " + highlighter.getStyleSheet());
    ...
    public void start(Stage primaryStage) {
        ...
        String css = JavaKeywords.class.getResource("/resource/editor/java_keywords.css").toString();
        System.out.println(css);
        
        SyntaxHighlighter highlighter = PluginService.getService(SyntaxHighlighter.class);
        //scene.getStylesheets().add(JavaKeywords.class.getResource("/resource/editor/java_keywords.css").toExternalForm());
